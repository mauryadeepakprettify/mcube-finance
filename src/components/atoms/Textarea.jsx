  ...
  return (
    <label className={`relative w-full ${className}`}>
      <textarea
        ...
        required={required}
        className={`peer w-full resize-none border-b bg-transparent pt-5 pb-2 transition-all duration-500 ease-in-out outline-none ${variant === "light" ? "border-white/70 text-white/70 focus:border-white " : "border-lambda/50 focus:border-primary text-black/70"}`}
      />
      <span
