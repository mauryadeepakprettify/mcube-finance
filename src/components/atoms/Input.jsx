    ...
    return (
        <div className="relative w-full">
            <input
                ...
                value={value}
                type={type}
                className="peer border-lambda/50 focus:border-primary w-full border-b bg-transparent pt-5 pb-2 text-alpha transition-all duration-500 ease-in-out outline-none"
