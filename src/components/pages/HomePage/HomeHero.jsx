...
const HomeHero = () => {
    return (
        <section className="h-[calc(60vh-76px)] md:h-[calc(70vh-76px)] lg:h-[calc(80vh-109px)] xl:h-[calc(100vh-109px)] relative before:content-[''] before:h-full before:w-full before:absolute before:inset-0 before:bg-[linear-gradient(269.32deg,rgba(0,0,0,0)_30.58%,rgba(0,0,0,0.85)_99.41%),linear-gradient(360deg,rgba(0,0,0,0)_46.63%,rgba(0,0,0,0.65)_100%)]">
