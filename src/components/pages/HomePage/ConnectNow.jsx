...
const ConnectNow = () => {
    return (
        <section className="py-12 bg-beta">
            <div className="container relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-32">
                <Image src="/icons/m.svg" alt="" width={246} height={202} className="absolute -bottom-12 left-[380px]" />
