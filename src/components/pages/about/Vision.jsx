...
const Vision = () => {
  return (
    <section className="relative h-[calc(60vh-76px)] md:h-auto before:absolute before:inset-0 before:h-full before:w-full before:bg-[linear-gradient(270deg,rgba(0,0,0,0)_38.95%,rgba(0,0,0,0.7)_77.81%)] before:content-[''] md:h-[calc(70vh-76px)] lg:h-[calc(80vh-109px)] xl:h-[calc(100vh-109px)]">
      <Image
      ...
      <div className="absolute top-1/2 right-6 left-6 -translate-y-1/2 transform lg:left-12">
        ...
        <p className="md:leading-[24px] text-base leading-[20px] md:text-left text-center md:text-base  text-white/70 lg:max-w-[450px]">
