...
const OurPhilosphy = () => {
  ...
  return (
    <section className="py-8 lg:py-16">
      <div className="container grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-10 xl:gap-18">
        <div>
          <Image
        ...
        <div>
          <h2 className="mb-8 text-[32px] leading-[36px] max-[375px]:text-[28px] max-[375px]:leading-[32px] md:mb-10 md:text-left lg:text-5xl lg:leading-[55px]">
